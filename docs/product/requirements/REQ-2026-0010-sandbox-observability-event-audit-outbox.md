...
2026-07-29：已形成由 AsyncAPI、Envelope Schema、Event Catalog、Outbox Contract、Audit Record Schema 与 Observability Catalog 组成的候选机器契约包；当前目录包含 33 个 Event Type 与 28 个 canonical Metric，Outbox 原子性/投递边界、审计安全身份、结构化日志、Trace 传播、backpressure、Resource Limit/Usage、Admission/Placement/Capacity、Node Enrollment/Identity/Attestation/Verified Inventory、PostgreSQL Quota/Capacity Reservation 事件和事实分离均可静态验证。`node --test tests/contract/sandbox-observability-contract.contract.test.mjs` 通过（10/10），完整 Contract Suite 通过（104/104）。所有新增契约均保持 `draft`/`implementationAuthorized: false`，REQ 继续等待 Owner、Security/Privacy、Database、Operations、PKI/Attestation、Capacity/Commerce、Retention、Release 与跨仓库 Trace Authority 人工评审。
