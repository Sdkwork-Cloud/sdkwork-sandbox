...
| P1 | Live PostgreSQL verification is environment-dependent. | Workspace tests skip the live repository test without `SDKWORK_DATABASE_TEST_POSTGRES_URL`. | Current local evidence is incomplete for release. |
